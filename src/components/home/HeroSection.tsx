      ...
      <div className="container relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="hero-title mb-6 flex items-center justify-center flex-wrap">
            <span className="word relative inline-block mr-[0.3em] aurora-text">
              <span className="relative z-10 text-gradient">Kuisoft</span>
              <div className="absolute inset-0 bg-gradient-to-r from-primary/50 to-secondary/50 blur-2xl -z-10 animate-aurora"></div>
            </span>
